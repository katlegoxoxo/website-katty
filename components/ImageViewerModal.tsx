        ...
        <AnimatePresence>
            ...
            >
                <motion.div
                    ...
                    className="bg-zinc-900/80 border border-white/10 rounded-xl w-full max-w-3xl max-h-[80vh] flex flex-col relative overflow-hidden shadow-2xl"
                ...
                >
                    ...
                    <div className="flex-grow flex items-start justify-center p-4 bg-black/20 overflow-hidden">
                        <img
                            src={certificate.imageUrl}
                            alt={`${certificate.name} certificate`}
                            className="max-w-[80%] max-h-[70%] object-contain shadow-2xl shadow-black/50 rounded mt-4"
                        />
                    </div>
