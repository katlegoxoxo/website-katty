  ...
  },
  {
    ...
    description: 'A collaborative learning platform for students, featuring subject-specific chat rooms, resource sharing, and a peer-to-peer tutoring scheduler to enhance academic support and engagement.',
     detailedDescription: [
      ...
      { title: 'Feature Breakdown', icon: 'fas fa-list-ul', content: 'The platform is built around three core features: 1) Real-time, subject-specific chat rooms for focused discussions. 2) A shared document repository for uploading and accessing study materials. 3) An integrated calendar for scheduling group study sessions or peer tutoring appointments.' },
      { title: 'Architecture & Tech', icon: 'fas fa-sitemap', content: 'The application was built using React for the frontend and Firebase for the backend. Firebase\'s Realtime Database and Authentication services were crucial for enabling instant messaging and secure user profiles. File storage was handled by Firebase Storage, providing a seamless experience for uploading and downloading resources.' },
